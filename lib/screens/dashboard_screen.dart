...
import 'package:dogdating/screens/Dog_maps_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  final screens = const [
    HomeScreen(),
    HomeScreen(), // Chat tab
    DogMapScreen(), // Add tab (middle)
    HomeScreen(), // Favorites tab
  ...
  Widget buildBottomNavBar() {
    return SizedBox(
      height: 60.h, // extra height so floating button has space
      child: Stack(
